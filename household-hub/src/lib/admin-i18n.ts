...
export const adminLabels = {
  ...
  whatsappReminderGroups: {
    ...
    zh: "出門／剩菜提醒的 WhatsApp 群組",
  },
  whatsappReminderGroupsHint: {
    en: "Where outing pings and the 10:00 leftover-dinner ask are posted. Paste a different 120363…@g.us if reminders should not go to the Q&A group. Leave blank = no reminder is sent. Save, then wait ~1 minute.",
    fil: "Saan ipinapadala ang outing ping at 10:00 leftover-dinner ask. Ibang 120363…@g.us kung ayaw sa Q&A group. Blank = walang reminder. I-Save, hintay ~1 minuto.",
    zh: "出門提醒與上午 10:00 剩菜詢問發到此群。若不要發到問答群，貼另一個 120363…@g.us。留空則不發送。儲存後約 1 分鐘生效。",
  },
