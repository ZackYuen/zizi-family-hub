...
const ui = {
  ...
  bannerBody: {
    en: "Golden Rules — no second chance. If something goes wrong, tell Sir or Mum right away.",
    fil: "Golden Rules — walang second chance. Kung may mali, sabihin agad kay Sir o Mum.",
    zh: "黃金守則 — 沒有第二次機會。有事立刻告訴 Sir 或 Mum。",
  },
  ifBroken: {
    en: "If Broken",
    fil: "If Broken",
